...
TEST_F(_03_Advanced, Integrated_Args_no_open)  {   
    ...
    CALL_FROM_FILE(((string)"-input ./datas/"+stestname+".dataset -events 500 -index-by UserID -report-by Brand -output ./data/"+stestname+"-hit2.dataset").c_str())<<"Execution of a simple test with 500 records only + mainargs"<<endl;
}
...
TEST_F(_03_Advanced, Integrated_Args_error_data)  {   
    ...
    CALL_FROM_FILE(((string)"-input ./data/"+stestname+".dataset -events 500 -index-by UserID -report-by Brand -output ./data/"+stestname+"-hit2.dataset").c_str())<<"Execution of a simple test with 500 records only + mainargs"<<endl;
}
...
TEST_F(_03_Advanced, Integrated_Args_error_missing_arg)  {   
    ...
    CALL_FROM_FILE(((string)"-input ./data/"+stestname+".dataset -index-by UserID -report-by Brand -output ./data/"+stestname+"-hit2.dataset").c_str())<<"Execution of a simple test with 500 records only + mainargs"<<endl;
}
...
TEST_F(_03_Advanced, Integrated_Args_error_bad_arg)  {   
    ...
    SET_TIMEOUT_S(15);
    EXPECTED_OUTPUT(Error in call);
    CALL_FROM_FILE(((string)"-i ./data/"+stestname+".dataset -events 500 -index-by UserID -report-by Brand -output ./data/"+stestname+"-hit2.dataset").c_str())<<"Execution of a simple test with 500 records only + mainargs"<<endl;
}
